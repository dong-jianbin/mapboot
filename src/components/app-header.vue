...
<m-navbar :theme="theme.theme.headerTheme">
  ...
  <m-nav>
    ...
    <a style="font-family:黑体 ;font-weight: 100;font-size: 25px; color: white;">开源地图脚手架</a>
  </m-nav>
  <m-nav align="right">
    <m-nav-item padding="0">
      <a href="https://github.com/dong-jianbin/mapboot" target="_blank"><i class="fa fa-github" style="font-size: 26px;vertical-align: middle;"></i>&nbsp;Github</a>
    </m-nav-item>
    <m-nav-item padding="0">
